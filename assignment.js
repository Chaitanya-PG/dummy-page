...
var characters=function(name)
{
for (x in cartooncharacters.pokemon)
  {
    if (cartooncharacters.pokemon[x].name==name)
    {
      alert (cartooncharacters.pokemon[x].id)
      alert (cartooncharacters.pokemon[x].num)
      alert (cartooncharacters.pokemon[x].img)
      for (y in (cartooncharacters.pokemon[x].type))
      {
        alert (cartooncharacters.pokemon[x].type[y])
      }
      alert (cartooncharacters.pokemon[x].height)
      alert (cartooncharacters.pokemon[x].weight)
      alert (cartooncharacters.pokemon[x].candy)
      alert (cartooncharacters.pokemon[x].candy_count)
      alert (cartooncharacters.pokemon[x].egg)
      alert (cartooncharacters.pokemon[x].spawn_chance)
      alert (cartooncharacters.pokemon[x].avg_spawns)
      alert (cartooncharacters.pokemon[x].spawn_time)
      alert (cartooncharacters.pokemon[x].multipliers)
      for (z in (cartooncharacters.pokemon[x].weaknesses))
      {
        alert (cartooncharacters.pokemon[x].weaknesses[z])
      }
...
var charPok=function(name1)
{
  var flag=0;
  for (a in cartooncharacters.pokemon)
  {
    for (b in cartooncharacters.pokemon[a].next_evolution)
    {
      if (cartooncharacters.pokemon[a].next_evolution[b].name==name1)
       {
         alert(cartooncharacters.pokemon[a].name)
         flag=1;
  ...
  if (flag=0)
  {
    alert ("Your input is not a pokemon character")
  }
  
}


var charweakness=function(weakness)
{
  for (g in cartooncharacters.pokemon)
  
    {
      for (h in cartooncharacters.pokemon[g].weaknesses)
        {
          if (cartooncharacters.pokemon[g].weaknesses[h]==weakness)
          {
            alert (cartooncharacters.pokemon[g].name)
          }
...
var pokemonname=prompt("Please type the pokemon you want the details about")
characters(pokemonname);

var inputagain=prompt("Please type the name of the next evolution pokemon")
charPok(inputagain);

var charweak=prompt("Please type the weakness of pokemon")
charweakness(charweak);